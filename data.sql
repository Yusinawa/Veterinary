...
INSERT INTO clinic.breed(title, pet_type) VALUES('EUBLEPHARIS', 'LIZARD');
INSERT INTO clinic.breed(title, pet_type) VALUES('BUDGERIGAR', 'PARROT');
INSERT INTO clinic.breed(title, pet_type) VALUES('DJUNGARIAN', 'HAMSTER');
INSERT INTO clinic.breed(title, pet_type) VALUES('PEKINGESE', 'DOG');
INSERT INTO clinic.breed(title, pet_type) VALUES('POMERANIAN', 'DOG');
INSERT INTO clinic.breed(title, pet_type) VALUES('HERMELIN', 'RABBIT');
INSERT INTO clinic.breed(title, pet_type) VALUES('PERSIAN', 'CAT');
INSERT INTO clinic.breed(title, pet_type) VALUES('GOLDEN', 'HAMSTER');
INSERT INTO clinic.breed(title, pet_type) VALUES('COCKATIEL', 'PARROT');
INSERT INTO clinic.breed(title, pet_type) VALUES('MUNCHKIN', 'CAT');
INSERT INTO clinic.breed(title, pet_type) VALUES('ST.BERNARD', 'DOG');

INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('SHURSHIK','MALE','2021-10-03','HEALTHY',0.08, 'LIZARD', 'EUBLEPHARIS', 1);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('ROCKY','MALE','2020-03-08','AVITAMINOSIS',0.04, 'PARROT', 'BUDGERIGAR', 11);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('PRYANIK','MALE','2021-03-17','HEALTHY',0.06, 'HAMSTER', 'DJUNGARIAN', 6);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('MISA','FEMALE','2021-02-06','PATELLA',5.50, 'DOG', 'PEKINGESE', 3);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('OSCAR','MALE','2020-10-03','HEALTHY',2.10, 'DOG', 'POMERANIAN', 4);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('SAKHOROK','FEMALE','2021-09-19','MALOCCLUSION',2.30, 'RABBIT', 'HERMELIN', 8);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('CHERNYSHKA','FEMALE','2021-11-01','PYOMETRA',4.00, 'CAT', 'PERSIAN', 2);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('PLYUSHA','FEMALE','2021-08-04','HEALTHY',0.20, 'HAMSTER', 'GOLDEN', 7);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('LAYMA','FEMALE','2021-06-29','HEALTHY',0.12, 'PARROT', 'COCKATIEL', 5);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('KNOPA','FEMALE','2020-08-31','HEALTHY',3.50, 'CAT', 'MUNCHKIN', 10);
INSERT INTO clinic.pet(nickname, gender, birthday, diagnosis, weight, pet_type, breed, customer_id) VALUES('BELLA','FEMALE','2021-07-09','HEALTHY',56.50, 'DOG', 'ST.BERNARD', 9);
